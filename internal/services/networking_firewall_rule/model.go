...
type NetworkingFirewallRuleModel struct {
	...
	Details            customfield.NestedObject[NetworkingFirewallRuleDetailsModel] `tfsdk:"details" json:"details,computed,no_refresh"`
}
...
type NetworkingFirewallRuleDetailsModel struct {
	Changes customfield.NestedObjectMap[NetworkingFirewallRuleDetailsChangesModel] `tfsdk:"changes" json:"changes,computed"`
}

type NetworkingFirewallRuleDetailsChangesModel struct {
