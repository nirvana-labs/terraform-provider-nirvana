...
var _ resource.ResourceWithModifyPlan = (*ProjectResource)(nil)
...
func (r *ProjectResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	_, err = r.client.Projects.New(
		ctx,
		projects.ProjectNewParams{},
...
func (r *ProjectResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	...
	res := new(http.Response)
	_, err = r.client.Projects.Update(
		ctx,
		data.ID.ValueString(),
...
func (r *ProjectResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
