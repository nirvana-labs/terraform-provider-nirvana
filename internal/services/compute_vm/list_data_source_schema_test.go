...
func TestComputeVMsDataSourceModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*compute_vm.ComputeVMsDataSourceModel)(nil)
	schema := compute_vm.ListDataSourceSchema(context.TODO())
