...
func TestNKSClusterPoolDataSourceModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*nks_cluster_pool.NKSClusterPoolDataSourceModel)(nil)
	schema := nks_cluster_pool.DataSourceSchema(context.TODO())
