...
var _ resource.ResourceWithModifyPlan = (*VPCResource)(nil)
...
func (r *VPCResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
	var data *VPCModel = new(VPCModel)
...
func (r *VPCResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
