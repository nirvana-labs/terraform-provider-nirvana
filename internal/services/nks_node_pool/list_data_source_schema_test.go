...
func TestNKSNodePoolsDataSourceModelSchemaParity(t *testing.T) {
	t.Parallel()
	model := (*nks_node_pool.NKSNodePoolsDataSourceModel)(nil)
	schema := nks_node_pool.ListDataSourceSchema(context.TODO())
