...
var _ resource.ResourceWithModifyPlan = (*VMResource)(nil)
...
func (r *VMResource) ModifyPlan(_ context.Context, _ resource.ModifyPlanRequest, _ *resource.ModifyPlanResponse) {
