...
type VMModel struct {
	...
	Storage       *[]*VMStorageModel                                 `tfsdk:"storage" json:"storage,required"`
	...
	StorageConfig customfield.NestedObjectList[VMStorageConfigModel] `tfsdk:"storage_config" json:"storage_config,computed"`
...
type VMStorageModel struct {
	...
	Unit     types.String `tfsdk:"unit" json:"unit,required"`
	DiskName types.String `tfsdk:"disk_name" json:"disk_name,optional"`
}
...
type VMStorageConfigModel struct {
	Size     types.Int64  `tfsdk:"size" json:"size,computed"`
	Type     types.String `tfsdk:"type" json:"type,computed"`
	Unit     types.String `tfsdk:"unit" json:"unit,computed"`
...
type VMVPCFirewallRulesModel struct {
	ID        types.String                                            `tfsdk:"id" json:"id,computed"`
	CreatedAt types.String                                            `tfsdk:"created_at" json:"created_at,computed"`
	Dest      customfield.NestedObject[VMVPCFirewallRulesDestModel]   `tfsdk:"dest" json:"dest,computed"`
	Name      types.String                                            `tfsdk:"name" json:"name,computed"`
...
type VMVPCFirewallRulesDestModel struct {
